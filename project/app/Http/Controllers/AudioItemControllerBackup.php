...
use App\Http\Controllers\Utils\AudioManager;
use App\Http\Controllers\Utils\StorageUtils;
use App\Http\Controllers\Utils\ContentManager;

class AudioItemControllerBackup extends AppBaseController
{
    public function index(Request $request): Factory|View|Application
    {
        ...
        $audioItems = $this->applyFiltersAndPagination($request, AudioItem::query(), $searchableFields);
