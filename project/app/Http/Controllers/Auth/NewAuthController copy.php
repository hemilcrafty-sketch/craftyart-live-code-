...
//            }
    ...
    function signup(Request $request): array|string
    {
        ...
        \Log::info("Signup API hit", [
            ...
            'referral_code_body' => $request->get('referral_code'),
            'referral_code_header' => $request->header('Referral-Code')
        ]);
        ...
        \Log::info("Signup createFirebaseUser Result", ['success' => $result['success'] ?? false]);
