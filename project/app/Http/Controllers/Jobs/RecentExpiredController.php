...
class RecentExpiredController extends ApiController
{
    ...
    private static function processUsersInChunks($frequency, int $days, string $targetDate, $emailLog, $whatsappLog, array $allTemplateData,$activeUserIds): void
    {
        $chunkSize = 100;
        $totalProcessed = 0;
        $chunkIndex = 0;
    ...
    private static function processSingleUser(
        ...
        try {
            $commonData = $transaction->getAutomationCommonData($frequency['suggested_plan'] ?? 0);
