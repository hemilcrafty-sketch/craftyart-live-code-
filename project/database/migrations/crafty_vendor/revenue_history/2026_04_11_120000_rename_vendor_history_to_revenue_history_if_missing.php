...
/**
 * Fixes installs that still have vendor_history but never ran the rename to revenue_history
 * (or ran ensure_revenue_history_table_exists which incorrectly skipped when vendor_history existed).
 */
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        if ($schema->hasTable('vendor_history')) {
            ...
            $this->ensureTypeEnumIncludesBankValidation();
    ...
    public function down(): void
    {
        ...
        if (! $schema->hasTable('revenue_history') || $schema->hasTable('vendor_history')) {
            return;
        }
    ...
    private function ensureTypeEnumIncludesBankValidation(): void
    {
        try {
            ...
            // Enum already includes bank_validation or engine does not support MODIFY
        }
    }
};
