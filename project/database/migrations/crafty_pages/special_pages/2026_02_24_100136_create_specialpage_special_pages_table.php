...
class CreateSpecialPageSpecialPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::connection('special_page_mysql')->hasTable('special_pages')) {
            return;
        }

        Schema::connection('special_page_mysql')->create('special_pages', function (Blueprint $table) {
            $table->id('id');
    ...
    {
        Schema::connection('special_page_mysql')->dropIfExists('special_pages');
    }
}
