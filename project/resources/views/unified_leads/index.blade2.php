                    ...
                    <form method="GET" action="{{ route('unified_leads.index') }}" class="ul-filters-form">
                        ...
                        <div class="ul-filter-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 mb-3">
                                    <label class="form-label">Feedback Followup (WA Feedback)</label>
                        ...
                        <div class="ul-filter-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 mb-3">
                                    <label class="form-label">Feedback Followup Label (WA Feedback)</label>
                                    ...
                                    <td>
                                        @if(!empty($lead['feedback_sent']))
                                            ...
                                            @if(!empty($lead['feedback_request_date_short']))
                                                <div class="meta-line">WA sent {{ $lead['feedback_request_date_short'] }}</div>
                                            @endif
                                            @if($lead['feedback_rating'] !== null && $lead['feedback_rating'] !== '')
                                                <div class="meta-line">Rating {{ $lead['feedback_rating'] }}/5</div>
                                            @endif
                                        @else
                                            <div class="ul-comm-stack">
                                                <span class="ul-comm-chip ul-comm-chip--no"><i
            ...
            <div class="modal-header"
                ...
                <div style="display: flex; align-items: center; width: 100%;">
                    ...
                    <div>
                        ...
                        <p style="color: rgba(255,255,255,0.9); font-size: 14px; margin: 0;" id="detailHeroName"></p>
                    </div>
                </div>
