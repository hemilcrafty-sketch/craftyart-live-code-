        ...
        <div class="min-height-200px">
            <div class="card-box mb-30">
                <div class="pd-20 border-bottom d-flex justify-content-between align-items-center">
                    <h4 class="text-blue h4 mb-0">Edit Job Opening</h4>
                ...
                <div class="pd-20">
                    ...
                    <form method="post" action="{{ route('job_openings.update', $job) }}" id="jobOpeningForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="jobTitle" value="{{ old('title', $job->title) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold text-dark">Slug <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="slug" id="jobSlug" value="{{ old('slug', $job->slug) }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control height-auto dynamic-file" 
                                            ...
                                            data-value="{{ $contentManager::getStorageLink(old('icon', $job->icon)) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="department" value="{{ old('department', $job->department) }}" placeholder="e.g. Engineering">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="font-weight-bold text-dark">Experience <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="experience" value="{{ old('experience', $job->experience) }}" placeholder="e.g. 1-3 Years" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="salary_range" value="{{ old('salary_range', $job->salary_range) }}" placeholder="e.g. $5k - $8k">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <div class="repeatable-container" data-name="responsibilities">
                                        @php $items = old('responsibilities', $job->responsibilities ?? ['']); if(empty($items)) $items = ['']; @endphp
                                        @foreach($items as $item)
                                        <div class="repeatable-row d-flex align-items-center mb-2 px-3 py-2 bg-light border-0">
                                            <input type="text" name="responsibilities[]" class="form-control" value="{{ $item }}" placeholder="e.g. Develop new features">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <div class="repeatable-container" data-name="requirements">
                                        @php $items = old('requirements', $job->requirements ?? ['']); if(empty($items)) $items = ['']; @endphp
                                        @foreach($items as $item)
                                        <div class="repeatable-row d-flex align-items-center mb-2 px-3 py-2 bg-light border-0">
                                            <input type="text" name="requirements[]" class="form-control" value="{{ $item }}" placeholder="e.g. 3+ years of Laravel experience">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <div class="repeatable-container" data-name-base="perks">
                                        @php 
                                            $items = old('perks', $job->perks ?? [['icon' => '', 'title' => '']]); 
                                            if(empty($items)) $items = [['icon' => '', 'title' => '']];
                                            $items = array_map(fn($i) => is_string($i) ? ['icon' => '', 'title' => $i] : $i, $items);
                                        @endphp
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-4">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input type="file" class="form-control height-auto dynamic-file" 
                                                            data-imgstore-id="perks[{{ $index }}][icon]"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input type="text" name="perks[{{ $index }}][title]" class="form-control" value="{{ $item['title'] ?? '' }}" placeholder="e.g. Health Insurance">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <div class="repeatable-container" data-name-base="tools">
                                        @php 
                                            $items = old('tools', $job->tools ?? [['icon' => '', 'title' => '']]); 
                                            if(empty($items)) $items = [['icon' => '', 'title' => '']];
                                            $items = array_map(fn($i) => is_string($i) ? ['icon' => '', 'title' => $i] : $i, $items);
                                        @endphp
                                        @foreach($items as $index => $item)
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-4">
                                                    <div class="form-group mb-0">
                                                        <label class="small font-weight-bold text-muted">Icon</label>
                                                        <input type="file" class="form-control height-auto dynamic-file" 
                                                            data-imgstore-id="tools[{{ $index }}][icon]"
                                                            data-value="{{ $contentManager::getStorageLink($item['icon'] ?? null) }}"
                                                            data-nameset="true" data-validate="false"
                                                            accept="image/*">
                                                    </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input type="text" name="tools[{{ $index }}][title]" class="form-control" value="{{ $item['title'] ?? '' }}" placeholder="e.g. Adobe Illustrator">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-right mt-2">
                        ...
                        <div class="mb-5 mt-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h5 class="h5 text-blue mb-0"><i class="fa fa-list-ol mr-2"></i> Interview Steps</h5>
                            </div>
                            
                            <div id="stepsContainer">
                                @php 
                                    $steps = old('interview_steps', $job->interview_steps ?? [['title' => '', 'description' => '']]); 
                        ...
                        <div class="mb-4 bg-light p-3 border rounded">
                            <div class="custom-control custom-checkbox mb-2">
                                ...
                                <input type="checkbox" class="custom-control-input" name="is_active" id="is_active" value="1" {{ old('is_active', $job->is_active ? '1' : '0') === '1' ? 'checked' : '' }}>
                                <label class="custom-control-label font-weight-bold" for="is_active">Job is active and visible</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="hidden" name="is_actively_hiring" value="0">
                                <input type="checkbox" class="custom-control-input" name="is_actively_hiring" id="is_actively_hiring" value="1" {{ old('is_actively_hiring', $job->is_actively_hiring ? '1' : '0') === '1' ? 'checked' : '' }}>
                                <label class="custom-control-label font-weight-bold text-blue" for="is_actively_hiring">Currently Actively Recruiting / Hiring</label>
                            </div>
                        </div>

                        <div class="pt-3 border-top">
                            <button type="submit" class="btn btn-primary px-5">Update Job Opening</button>
                            <a href="{{ route('job_openings.index') }}" class="btn btn-outline-secondary ml-2">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
