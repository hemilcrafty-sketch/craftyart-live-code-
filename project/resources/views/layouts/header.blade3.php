    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                @if (!$roleManager::isSalesManager(Auth::user()->user_type) && !$roleManager::isSalesEmployee(Auth::user()->user_type) && !$roleManager::isHr(Auth::user()->user_type))
                                @if ($roleManager::getUserType(Auth::user()->user_type) == \App\Enums\UserRole::SEO_EXECUTIVE->value)
                                    <li class="dropdown">
                                        <a href="{{ route('dashboard') }}"
                                ...
                                @elseif ($roleManager::getUserType(Auth::user()->user_type) == \App\Enums\UserRole::SEO_MANAGER->value || $roleManager::getUserType(Auth::user()->user_type) == \App\Enums\UserRole::MANAGER->value)
                                    <li class="dropdown">
                                ...
                                @elseif (!$roleManager::isAdmin(Auth::user()->user_type))
                ...
                @endif
                @if ($roleManager::isAdminOrHr(Auth::user()->user_type))
                    <li
                        class="dropdown {{ in_array(Route::currentRouteName(), ['career_page.edit', 'job_openings.index', 'job_openings.create', 'job_openings.edit', 'job_applications.index', 'job_applications.show']) ? 'show' : '' }}">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-briefcase"></span><span class="mtext">Career</span>
                        </a>
                        <ul class="submenu"
                            style="display: {{ in_array(Route::currentRouteName(), ['career_page.edit', 'job_openings.index', 'job_openings.create', 'job_openings.edit', 'job_applications.index', 'job_applications.show']) ? 'block' : 'none' }};">
                            <li>
                                <a href="{{ route('career_page.edit') }}"
                                    class="{{ Route::currentRouteName() == 'career_page.edit' ? 'selectSubMenu' : '' }}">Career
                                    page</a>
                            </li>
                            <li>
                                <a href="{{ route('job_openings.index') }}"
                                    class="{{ in_array(Route::currentRouteName(), ['job_openings.index', 'job_openings.create', 'job_openings.edit']) ? 'selectSubMenu' : '' }}">Job
                                    openings</a>
                            </li>
                            <li>
                                <a href="{{ route('job_applications.index') }}"
                                    class="{{ in_array(Route::currentRouteName(), ['job_applications.index', 'job_applications.show']) ? 'selectSubMenu' : '' }}">Job
                                    applications</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        : 'none' }};">
                                        ...
                                        <li>
                                            <a href="{{ route('designer_system.designers') }}"
                                                ...
                                                <i class="fa fa-users"></i> Designers
                                            </a>
                                        </li>
                                        ...
                                        <li
                                            class="dropdown {{ in_array(Route::currentRouteName(), ['designer_system.types', 'designer_system.goals']) ? 'show' : '' }}">
                                            <a href="javascript:;" class="dropdown-toggle">
                                                <i class="fa fa-cog"></i> System Settings
                                            </a>
                                            <ul class="submenu"
                                                style="display:{{ in_array(Route::currentRouteName(), ['designer_system.types', 'designer_system.goals']) ? 'block' : 'none' }};">
                                                <li>
                                ...
                                <li>
                                    <a href="{{ route('payment_configuration.index') }}"
                                        ...
                                        <span class="micon bi bi-calendar4-week"></span><span class="mtext">Paymeny
                                            Configuration</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="{{ route('offer-package.index') }}"
                                        class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'offer-package.index' ? 'selectSubMenu' : '' }}">
                                        <span class="micon">
                                            <img src="{{ asset('assets/vendors/images/menu_icon/Template.svg') }}" alt="">
                                        </span>
                                        <span class="mtext">Offer Package</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ route('offer-page.index') }}"
                                        class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'offer-page.index' ? 'selectSubMenu' : '' }}">
                                        <span class="micon">
                                            <img src="{{ asset('assets/vendors/images/menu_icon/Template.svg') }}" alt="">
                                        </span>
                                        <span class="mtext">Offer Page</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    class="dropdown {{ in_array(Route::currentRouteName(), ['categoryFeatures.index', 'features.index', 'planduration.index', 'plans.index', 'plans.create', 'plans.edit']) ? 'show' : '' }}">
                                    <a href="javascript:;" class="dropdown-toggle">
                                        <span class="micon">
                ...
                @if ($roleManager::salesHierarchyAccess(Auth::user()->user_type))
                    <li>
                        <a href="{{ route('unified_leads.index') }}"
                            class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'unified_leads.index' ? 'selectSubMenu' : '' }}">
                            <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/Contacts.svg') }}"
                                    alt=""></span><span class="mtext">Unified Leads</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('wp_feedback.index') }}"
                            class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'wp_feedback.index' ? 'selectSubMenu' : '' }}">
                            <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/Feedback.svg') }}"
                                    alt=""></span><span class="mtext">Whatsapp Feedback</span>
                        </a>
                    </li>

                    @if ($roleManager::isAdminSalesManagerOrNisha(Auth::user()->id))
                        <li>
                            <a href="{{ route('custom_leads.index') }}"
                                class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'custom_leads.index' ? 'selectSubMenu' : '' }}">
                                <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/Filter.svg') }}"
                                        alt=""></span><span class="mtext">Custom Leads</span>
                            </a>
                        </li>
                    @endif
                ...
                @if ($roleManager::isAdmin(Auth::user()->user_type))
                    ...
                    <li
                        class="dropdown {{ in_array(Route::currentRouteName(), ['vendor.withdrawals', 'vendor.withdrawal.show', 'vendor.wallet_settings', 'vendor.wallet_settings.create', 'vendor.wallet_settings.edit']) ? 'show' : '' }}">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon"><i class="fa fa-money-bill-wave" aria-hidden="true"></i></span><span
                                class="mtext">Vendor Management</span>
                        </a>
                        <ul class="submenu"
                            style="display: {{ in_array(Route::currentRouteName(), ['vendor.withdrawals', 'vendor.withdrawal.show', 'referral.dashboard', 'vendor.wallet_settings', 'vendor.wallet_settings.create', 'vendor.wallet_settings.edit']) ? 'block' : 'none' }};">
                            <li>
                                <a href="{{ route('referral.dashboard') }}"
                                    class="{{ in_array(Route::currentRouteName(), ['referral.dashboard', 'referral.show']) ? 'selectSubMenu' : '' }}">
                                    <i class="fa fa-users"></i> Referral Users
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('vendor.withdrawals') }}"
                                    class="{{ in_array(Route::currentRouteName(), ['vendor.withdrawals', 'vendor.withdrawal.show']) ? 'selectSubMenu' : '' }}">
                                    <i class="fa fa-money-bill"></i> Withdrawal Requests
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('vendor.wallet_settings') }}"
                                    class="{{ in_array(Route::currentRouteName(), ['vendor.wallet_settings', 'vendor.wallet_settings.create', 'vendor.wallet_settings.edit']) ? 'selectSubMenu' : '' }}">
                                    <i class="fa fa-cog"></i> Wallet Settings
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @endif
                @if ($roleManager::isAdminOrSeoManager(Auth::user()->user_type) || $roleManager::isSeoExecutiveOrIntern(Auth::user()->user_type))
                    <li>
                    ...
                    <li>
                        <a href="{{ route('rejecte_task') }}"
                            class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'rejecte_task' ? 'selectSubMenu' : '' }}">
                            <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/Contacts.svg') }}"
                                    alt=""></span><span class="mtext">Rejected Tasks</span>
                        </a>
                    </li>
                @endif
            </ul>
