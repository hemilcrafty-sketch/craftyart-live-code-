                 ...
                 <tr>
                  <td valign="top" align="center" style="padding:0;Margin:0;width:270px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" class="es-m-p10b" style="padding:0;Margin:0;font-size:0"><img src="https://evnunaj.stripocdn.email/content/guids/CABINET_4b4adcbf718f1a29106b9bd33a8de6af2546c3cd6d9ee82662e9e0540ef3b044/images/download_1.png" alt="" height="64" class="img-8194" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;border-radius:0"></td>
                     </tr>
                   </table></td>
                 </tr>
               ...
               <table cellspacing="0" cellpadding="0" align="right" class="es-right" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:270px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" height="64" class="es-text-7069 h-auto es-m-p10t" style="padding:0;Margin:0"><h1 class="es-text-mobile-size-20 es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#333333"><a target="_blank" href="https://www.craftyartapp.com/" style="mso-line-height-rule:exactly;text-decoration:none;color:#5961f8;font-size:20px;line-height:24px">Create Design</a> |&nbsp; <a target="_blank" href="https://www.craftyartapp.com/templates" style="mso-line-height-rule:exactly;text-decoration:none;color:#5961F8;font-size:20px;line-height:24px">Templates</a></h1></td>
                     </tr>
                   </table></td>
                 </tr>
