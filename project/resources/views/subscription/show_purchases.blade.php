            ...
            <div class="card-box mb-30">
                <div class="pb-20">
                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        @if ($datas['showCaricatureHistory'] ?? false)
                            <div class="pd-20">
                                <a target="_blank" href="{{ route('caricature_history.index') }}" class="btn btn-primary">Show Created</a>
                            </div>
                        @endif
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Amount</th>
                                        <th>Email Send</th>
                                        <th style="word-break: break-word"> Wp Send</th>
                                        <th>Payment Time</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($datas['transcationArray'] as $transcation)
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank"href="user_detail/{{ $transcation->user_id }}">{{ $transcation->user_id }}</a>
                                            </td>
