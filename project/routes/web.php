...
Route::group(['middleware' => ['restrict.ip']], function () {
	...
	Route::get('/wp-feedback-new', [App\Http\Controllers\Automation\NewWpFeedbackController::class, 'index'])->name('wp_feedback.new_index')->middleware(IsSalesAccess::class);
	Route::post('/wp-feedback-new/followup', [App\Http\Controllers\Automation\NewWpFeedbackController::class, 'followupUpdate'])->name('wp_feedback.new_followupUpdate')->middleware(IsSalesAccess::class);
	Route::post('/wp-feedback/followup-update', [App\Http\Controllers\Automation\WpFeedbackController::class, 'followupUpdate'])->name('wp_feedback.followupUpdate')->middleware(IsSalesAccess::class);

	// Recent Expire
	Route::get('/recent-expire', [RecentExpireController::class, 'index'])->name('recent_expire.index')->middleware(IsSalesAccess::class);
	Route::get('/recent-expire-new', [App\Http\Controllers\Automation\NewRecentExpireController::class, 'index'])->name('recent_expire.new_index')->middleware(IsSalesAccess::class);
	Route::post('/recent-expire-new/followup', [App\Http\Controllers\Automation\NewRecentExpireController::class, 'followupUpdate'])->name('recent_expire.new_followupUpdate')->middleware(IsSalesAccess::class);
