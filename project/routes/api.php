...
use App\Http\Controllers\Api\CareerPageApiController;
use App\Http\Controllers\Api\JobOpeningApiController;
...
Route::get('jobs/{slug}', [JobOpeningApiController::class, 'show']);
Route::get('career-page', [CareerPageApiController::class, 'show']);